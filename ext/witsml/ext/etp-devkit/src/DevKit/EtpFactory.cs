...
namespace Energistics.Etp
{
    ...
    public static class EtpFactory
    {
        ...
        {
            return CreateClient((WebSocketType)Enum.Parse(typeof(WebSocketType), Settings.Default.DefaultWebSocketType, true)
                , uri, application, version, etpSubProtocol, EmptyHeaders);
        }
        ...
        {
            return CreateClient((WebSocketType)Enum.Parse(typeof(WebSocketType), Settings.Default.DefaultWebSocketType, true)
                , uri, application, version, etpSubProtocol, headers);
        }
        ...
        {
            return CreateSelfHostedWebServer((WebSocketType)Enum.Parse(typeof(WebSocketType), Settings.Default.DefaultWebSocketType, true)
                , port, application, version);
        }
