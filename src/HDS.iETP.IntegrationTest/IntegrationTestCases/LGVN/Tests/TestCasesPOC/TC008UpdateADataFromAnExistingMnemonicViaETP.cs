...
{
    [TestClass]
    public class TC008UpdateADataFromAnExistingMnemonicViaETP : TestBase2
    {
        ...
        [TestCategory("POC")]
        [TestMethod]
        [Description("UpdateADataFromAnExistingMnemonicViaETP")]
        public async Task POC8UpdateADataFromAnExistingMnemonicViaETP()
        {
