...
namespace HDS.iETP.IntegrationTestCases.LGVN.Tests.Sample
{
    ...
    public class StreamingTests : TestBase
    {
        ...
        public async Task Test_Streaming()
        {
            ...
            uris.Add("eml://witsml14/well(e237d8f5-a5bf-430b-9d8a-e6a078bc3717)");
            ...
            //Stream Depth Index
            int startInDex = 1;
            var channelStreaming = channels.Where(c => c.ChannelName == "TFHA").First();
            ...
            var streamResponse2 = await StreamingChannel(listChannels, count: -1, throwable: false);
